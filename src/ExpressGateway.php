...
/**
 * Euplatesc.ro Express Class
 */
class ExpressGateway extends ProGateway
{
    public function getName()
    {
        return 'Euplatesc.ro Express';
    }
    ...
    {
        return $this->createRequest('\Omnipay\Euplatesc\Message\ExpressAuthorizeRequest', $parameters);
    }

    public function completeAuthorize(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Euplatesc\Message\ExpressCompleteAuthorizeRequest', $parameters);
    }
    ...
    {
        return $this->createRequest('\Omnipay\Euplatesc\Message\ExpressCompletePurchaseRequest', $parameters);
    }

    public function fetchCheckout(array $parameters = array())
    {
        return $this->createRequest('\Omnipay\Euplatesc\Message\ExpressFetchCheckoutRequest', $parameters);
    }
}
